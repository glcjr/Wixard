...
namespace WIXSharpHelper
{
    ...
    public class Users : ISerializable
    {
        ...
        public void Add(string name, string password, string domain = "Environment.MachineName", bool pwneverexpire = true)
        {
            users.Add(new User(name, password, domain, pwneverexpire));
        }
        ...
        public ObservableCollection<User> GetCertslist()
        {
